...
<div class="panel">
    <div class="panel-middle" id="judul">
        ...
        <div id="judul-text">
            <h2 class="text-green">Prodi Apa yang Kinerjanya Bagus??</h2>
...
<div class="row">
    ...
    <h2 ></h2> 
                        ...
                        <?php
                        $url='http://localhost/pmb/webservice/grafik_wisuda.php';
                        ...
                        <select type ="text" id="tahun" name = "tahun" class="form-custom" required>
                            <?php 
    ...
    <div class="col-8">
        <div class="panel">
            <div class="panel-top">
                <b class="text-green">Data Mahasiswa Wisuda</b>
            </div>
                   ...
                   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
                        <script type="text/javascript">
                            $("#tahun").change(function(e){
                                ...
                                $.getJSON(`http://localhost/PMB/webservice/grafik_wisuda.php?tahun=${tahun}`, function( data ) {


    var isi_labels = [];
    var isi_data=[];
    $(data.list_info).each(function(i){         
        isi_labels.push(data.list_info[i].prodi);
