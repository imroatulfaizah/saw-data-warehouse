...
<?php
                        $url='http://localhost/pmb/webservice/grafik_darul.php';
...
<div class="panel">
    <div class="panel-middle text-center">
        <h1>
           <span class="text-green">Laporan Cuti</span><br>
    ...
    <div class="panel-middle text-center">
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
                        <script type="text/javascript">
                                ...
                                $.getJSON(`http://localhost/PMB/webservice/grafik_darul.php`, function( data ) {


    var isi_labels = [];
    var isi_data=[];
    $(data.list_info).each(function(i){         
        isi_labels.push(data.list_info[i].tahun);
