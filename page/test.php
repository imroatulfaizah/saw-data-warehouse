...
<div class="panel">
    <div class="panel-middle" id="judul">
        ...
        <div id="judul-text">
            <h2 class="text-green">Laporan Data SMA/SMK Sederajat</h2>
...
<div class="row">
    ...
    <h2 ></h2> 
                        ...
                        <?php
                        $url='http://localhost/pmb/webservice/list_json_tahun.php';
    ...
    <div class="panel-middle text-center">
        <table>
            ...
            <?php
                        $url='http://localhost/pmb/webservice/list_json_sekolah.php';
                        $json = file_get_contents($url);
            ...
            <?php 
                        ...
                        $no = 0;
                        foreach ($krs['list_sekolah'] as $kr) {
                            $no++;
                            foreach ($kr as $key => $value) {
                                $$key=$value;
                            }
    ...
    <div class="panel-bottom"></div>
        ...
        <div class="panel">
            <div class="panel-top">
                <b class="text-green">Daftar Asal SMA/SMK</b>
            </div>
                   ...
                   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
                        <script type="text/javascript">
                            $("#tahun_lulus").change(function(e){
                                ...
                                $.getJSON(`http://localhost/PMB/webservice/list_json_tahun.php?tahun_lulus=${tahun_lulus}`, function( data ) {


    var isi_labels = [];
    var isi_data=[];
    $(data.list_info).each(function(i){         
        isi_labels.push(data.list_info[i].nama_sekolah);
